...
const Hero = () => {
  ...
  return (
    <section className="relative w-full py-12 text-white text-center bg-blue overflow-hidden flex flex-col lg:flex-row items-center mt-8">
      {/* Left Side Text */}
      <div className="w-full lg:w-1/2 text-left p-8">
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-gold font-serif mb-8">
          Welcome to Zen Hub
        </h2>
        <p className="font-sans text-lg sm:text-xl md:text-2xl text-white mb-8">
